...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/10 18:25:31 by ybel-hac          #+#    #+#             */
/*   Updated: 2023/01/10 21:03:20 by ybel-hac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char *s1, char *s2)
{
	...
	ft_strcpy(final_str + i, " ");
	ft_strcpy(final_str + (i + 1), "\0");
	if (s2)
		ft_strcpy(final_str + (i + 1), s2);
	free(s1);
	return (final_str);
}